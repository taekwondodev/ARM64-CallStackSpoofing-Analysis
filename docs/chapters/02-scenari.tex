...
\texttt{WriteProcessMemory} e \texttt{CreateRemoteThread}.

La baseline e le due tecniche di spoofing documentano come
l'operazione offensiva appare agli strumenti di analisi dello stack in funzione
